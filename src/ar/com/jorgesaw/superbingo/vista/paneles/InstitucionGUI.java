...
public class InstitucionGUI extends VistaCRUDTablaImpl implements IPanelInstitucion {

	private static final long serialVersionUID = 3301228065869672989L;
	private final int cantDatosValidar = 8;
	
	public InstitucionGUI() {
		super();
	...
	public void limpiarDatos() {
		...
		dateChooserAltaInstit.resetValue();
		dateChooserAltaInstit.getMsgAsociado().setForeground(SuperBingoTheme.VALIDADO);
	}
...
Font fuenteLabel = new java.awt.Font("SansSerif", 0, 12);
        ...
        txtPrefTel          = new MyJTextCadenaCiudad(IPanelEmpleados.TEXT_DDN_TEL, 1, 
        		IPanelEmpleados.MAX_LONG_DDN, false);
        dateChooserAltaInstit  = new MyJDateChooser(IPanelEmpleados.FECHA_ALTA, true);// new com.toedter.calendar.JDateChooser();
...
//        txtPrefCel.setMsgAsociado(lblCel);
        ...
        txtTel.setNextFocusableComponent((Component) dateChooserAltaInstit.getDateEditor());
...
//        txtPrefTel.setMsgAsociado(lblTel);
        ...
        dateChooserAltaInstit.setDateFormatString("dd-MM-yyyy");
        dateChooserAltaInstit.setMsgAsociado(lblFechIng);
        dateChooserAltaInstit.setNextFocusableComponent(txtAreaObserv);
        dateChooserAltaInstit.addSuscriptor(this);
...
//        setPreferredSize(new java.awt.Dimension(826, 570));
        ...
        lblFechIng.setText("Fecha de ingreso:");
...
//        comboProv.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        panelDatosBasico2Layout.setHorizontalGroup(
            ...
            .addGroup(panelDatosBasico2Layout.createSequentialGroup()
                ...
                .addGroup(panelDatosBasico2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtCel)
                    .addComponent(txtTel)
                    .addComponent(dateChooserAltaInstit, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        panelDatosBasico2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDatosBasico2Layout.createSequentialGroup()
                ...
                .addGroup(panelDatosBasico2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDatosBasico2Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(dateChooserAltaInstit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
	...
	private MyJDateChooser dateChooserAltaInstit;
