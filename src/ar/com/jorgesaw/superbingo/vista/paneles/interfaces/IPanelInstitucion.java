...
public interface IPanelInstitucion extends IPanelDireccTel {

	static final String TEXT_TIPO = "TIPO";
	static final String TEXT_DESCRIPCION = "Descripcion";
	static final String TEXT_ALIAS = "Alias";
